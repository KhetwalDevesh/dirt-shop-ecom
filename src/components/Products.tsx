...
const Products = () => {
	...
	if (loading) {
		return (
			<div className="sm:px-[30px] my-[30px] flex flex-wrap basis-4/12  justify-between px-[120px]">
				{fallbackProducts.map((productItem: productItemProps) => {
					return (
						<div className="flex sm:justify-center sm:w-full mb-[40px]">
							<Link
								...
								<div className="flex justify-between sm4:w-[12rem] sm3:w-[15rem] sm2:w-[20rem]  sm:w-[25rem] md:text-[16px] md:w-[12rem] lg:w-[17rem] xl:w-[20rem] 2xl:w-[28rem]  pt-[1.7rem] font-outfit text-[18px] w-[25rem]  font-semibold text-[#2C382F] leading-[28px] tracking-[.06rem]">
