...
const Cart = () => {
	...
	return (
		<div className="bg-lemon-light min-h-screen">
			<h1 className="text-[48px] leading-[60px] mx-12 py-[1rem] tracking-[.06rem] text-[#DD7339]">
				Your Cart
			</h1>
			<div className="grid grid-cols-4 mx-12 py-10 border-b-[1px] border-black">
				...
				{cartItems.map((cartItem) => {
					return (
						<div key={cartItem?._id} className="min-w-screen ">
							<div className="grid grid-cols-4 justify-between min-w-screen mx-12 py-10 border-b-[1px] border-black">
