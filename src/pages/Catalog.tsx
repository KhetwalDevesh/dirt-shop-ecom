...
const Catalog = () => {
	...
	return (
		<div className="bg-lemon-light min-h-screen pt-[60px]">
			...
			<div className="my-[30px] flex  basis-4/12 justify-between px-[60px]">
					...
					return (
						<div className="flex sm:justify-center sm:w-full mb-[30px]">
							<div
								...
								<div className="sm4:w-[12rem] sm3:w-[15rem] sm2:w-[20rem]  sm:w-[25rem] md:text-[16px] md:w-[12rem] lg:w-[17rem] xl:w-[20rem] 2xl:w-[28rem] flex justify-between w-[35rem] py-[1.7rem] pb-0 font-outfit text-[18px] font-semibold text-[#2C382F] leading-[28px] tracking-[.06rem]">
